...
import { DarkModeOutlinedIcon, LightModeOutlinedIcon, PersonAddIcon } from "@/utils/Icons";
...
export default function Header() {
    ...
    return (
        <div className="h-[12%] sticky top-0 z-50 w-full bg-[#020617] flex items-center justify-between px-20">
            <Link href="/" className="text-[#467BFF] flex items-center justify-center cursor-pointer">
            ...
            <div className="flex items-center justify-center">
                <span className="mx-[6px] cursor-pointer">
                    {
                        mode ? (
                            <LightModeOutlinedIcon onClick={() => setMode(!mode)} className="text-[#94A3B8] scale-110" />
                        ) : (
                            <DarkModeOutlinedIcon onClick={() => setMode(!mode)} className="text-[#94A3B8] scale-110" />
                        )
                    }
                </span>
