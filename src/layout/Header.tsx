...
export default function Header() {
    return (
        <div className="h-[12%] w-full bg-[#020617] flex items-center justify-between px-20">
            ...
            <div>
                <span className="mx-[6px]"><LightModeOutlinedIcon className="text-[#94A3B8] scale-110" /></span>
                <button className="durarion-200 transition-all bg-[#f5f9ff] hover:bg-zinc-200 text-[#1E293B] text-sm font-semibold px-4 py-2 rounded-full mx-[6px]"><PersonAddIcon className=" scale-[0.8]" /> Register</button>
